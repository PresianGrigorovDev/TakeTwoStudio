...
use App\Filament\Resources\AutomotiveExtraResource\Pages;
...
class AutomotiveExtraResource extends Resource
{
    ...
    protected static ?string $slug = 'automotive-extras';

    public static function getEloquentQuery(): Builder
    {
        $service = \App\Models\Service::where('slug', 'automotive')->first();
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\Hidden::make('service_id')
                ->default(fn () => \App\Models\Service::where('slug', 'automotive')->first()?->id),
    ...
    {
        return [
            'index'  => Pages\ListAutomotiveExtras::route('/'),
            'create' => Pages\CreateAutomotiveExtra::route('/create'),
            'edit'   => Pages\EditAutomotiveExtra::route('/{record}/edit'),
        ];
    }
}
