...
use App\Filament\Resources\CommercialExtraResource\Pages;
...
class CommercialExtraResource extends Resource
{
    ...
    protected static ?string $slug = 'commercial-extras';

    public static function getEloquentQuery(): Builder
    {
        $service = \App\Models\Service::where('slug', 'commercial')->first();
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\Hidden::make('service_id')
                ->default(fn () => \App\Models\Service::where('slug', 'commercial')->first()?->id),
    ...
    {
        return [
            'index'  => Pages\ListCommercialExtras::route('/'),
            'create' => Pages\CreateCommercialExtra::route('/create'),
            'edit'   => Pages\EditCommercialExtra::route('/{record}/edit'),
        ];
    }
}
