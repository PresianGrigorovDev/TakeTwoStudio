...
use App\Filament\Resources\WeddingExtraResource\Pages;
...
class WeddingExtraResource extends Resource
{
    ...
    protected static ?string $slug = 'wedding-extras';

    public static function getEloquentQuery(): Builder
    {
        $service = \App\Models\Service::where('slug', 'weddings')->first();
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\Hidden::make('service_id')
                ->default(fn () => \App\Models\Service::where('slug', 'weddings')->first()?->id),
    ...
    {
        return [
            'index'  => Pages\ListWeddingExtras::route('/'),
            'create' => Pages\CreateWeddingExtra::route('/create'),
            'edit'   => Pages\EditWeddingExtra::route('/{record}/edit'),
        ];
    }
}
