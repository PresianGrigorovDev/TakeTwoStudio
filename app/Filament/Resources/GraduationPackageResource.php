...
use App\Filament\Resources\GraduationPackageResource\Pages;
...
class GraduationPackageResource extends Resource
{
    protected static ?string $model = GraduationPackage::class;
    ...
    {
        return [
            'index'  => Pages\ListGraduationPackages::route('/'),
            'create' => Pages\CreateGraduationPackage::route('/create'),
            'edit'   => Pages\EditGraduationPackage::route('/{record}/edit'),
        ];
    }
}
