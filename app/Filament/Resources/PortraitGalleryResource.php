...
use App\Filament\Resources\PortraitGalleryResource\Pages;
use App\Models\PortraitGallery;
use Filament\Forms;
...
class PortraitGalleryResource extends Resource
{
    protected static ?string $model = PortraitGallery::class;
                ...
                Forms\Components\Section::make('Основна Информация')
                    ->schema([
                        ...
                        Forms\Components\Placeholder::make('cover_image_preview')
                            ->label('Текуща корица')
                            ->content(fn (?PortraitGallery $record): \Illuminate\Support\HtmlString =>
                        ...
                        Forms\Components\FileUpload::make('cover_image')
                            ...
                            ->directory('portrait_galleries/covers')
                            ->disk('public')
                        ...
                        Forms\Components\Repeater::make('photos')
                            ...
                            ->schema([
                                Forms\Components\FileUpload::make('image_path')
                                    ...
                                    ->imageResizeTargetWidth('1920')
                                    ->imageResizeTargetHeight('1080')
                                    ->directory('portrait_galleries/photos')
                                    ->disk('public')
                                    ->required(),
                            ])
    ...
    {
        return [
            'index' => Pages\ListPortraitGalleries::route('/'),
            'create' => Pages\CreatePortraitGallery::route('/create'),
            'edit' => Pages\EditPortraitGallery::route('/{record}/edit'),
        ];
    }
}
