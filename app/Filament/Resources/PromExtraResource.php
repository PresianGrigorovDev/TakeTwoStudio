...
use App\Filament\Resources\PromExtraResource\Pages;
...
class PromExtraResource extends Resource
{
    ...
    protected static ?string $slug = 'prom-extras';

    public static function getEloquentQuery(): Builder
    {
        $service = \App\Models\Service::where('slug', 'proms')->first();
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\Hidden::make('service_id')
                ->default(fn () => \App\Models\Service::where('slug', 'proms')->first()?->id),
    ...
    {
        return [
            'index'  => Pages\ListPromExtras::route('/'),
            'create' => Pages\CreatePromExtra::route('/create'),
            'edit'   => Pages\EditPromExtra::route('/{record}/edit'),
        ];
    }
}
