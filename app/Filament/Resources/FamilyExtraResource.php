...
use App\Filament\Resources\FamilyExtraResource\Pages;
...
class FamilyExtraResource extends Resource
{
    ...
    protected static ?string $slug = 'family-extras';

    public static function getEloquentQuery(): Builder
    {
        $service = \App\Models\Service::where('slug', 'family')->first();
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\Hidden::make('service_id')
                ->default(fn () => \App\Models\Service::where('slug', 'family')->first()?->id),
    ...
    {
        return [
            'index'  => Pages\ListFamilyExtras::route('/'),
            'create' => Pages\CreateFamilyExtra::route('/create'),
            'edit'   => Pages\EditFamilyExtra::route('/{record}/edit'),
        ];
    }
}
