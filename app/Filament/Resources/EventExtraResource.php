...
use App\Filament\Resources\EventExtraResource\Pages;
...
class EventExtraResource extends Resource
{
    ...
    {
        $service = \App\Models\Service::where('slug', 'events')->first();
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\Hidden::make('service_id')
                ->default(fn () => \App\Models\Service::where('slug', 'events')->first()?->id),
    ...
    {
        return [
            'index'  => Pages\ListEventExtras::route('/'),
            'create' => Pages\CreateEventExtra::route('/create'),
            'edit'   => Pages\EditEventExtra::route('/{record}/edit'),
        ];
    }
}
