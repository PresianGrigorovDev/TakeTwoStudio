...
use App\Filament\Resources\PromPackageResource\Pages;
...
class PromPackageResource extends Resource
{
    protected static ?string $model = PromPackage::class;
    ...
    {
        return [
            'index'  => Pages\ListPromPackages::route('/'),
            'create' => Pages\CreatePromPackage::route('/create'),
            'edit'   => Pages\EditPromPackage::route('/{record}/edit'),
        ];
    }
}
