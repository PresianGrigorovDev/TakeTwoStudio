...
use App\Filament\Resources\PortraitExtraResource\Pages;
...
class PortraitExtraResource extends Resource
{
    ...
    protected static ?string $slug = 'portrait-extras';

    public static function getEloquentQuery(): Builder
    {
        $service = \App\Models\Service::where('slug', 'portrait')->first();
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\Hidden::make('service_id')
                ->default(fn () => \App\Models\Service::where('slug', 'portrait')->first()?->id),
    ...
    {
        return [
            'index'  => Pages\ListPortraitExtras::route('/'),
            'create' => Pages\CreatePortraitExtra::route('/create'),
            'edit'   => Pages\EditPortraitExtra::route('/{record}/edit'),
        ];
    }
}
