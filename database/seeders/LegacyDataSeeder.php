...
class LegacyDataSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        \App\Models\Faq::create([
            'page_slug' => 'baptism',
            'question_bg' => 'Колко време отнема заснемането на Свето Кръщение?',
            'answer_bg' => 'Самият църковен ритуал обикновено трае около 40-50 минути. Ние винаги сме там 15-20 минути по-рано, за да снимаме детайлите и гостите. След ритуала отделяме време за семейна фотосесия пред църквата. Общо ангажиментът е около 1.5 часа (за пакет "Само Църква").',
            'display_order' => 1
        ]);
        \App\Models\Faq::create([
            'page_slug' => 'baptism',
            'question_bg' => 'Кога получаваме снимките и видеото?',
            'answer_bg' => 'Стандартният срок за предаване на обработените кадри и видеото е до 30 работни дни. Ако имате нужда от материалите по-бързо, предлагаме услуга "Експресна обработка" (до 3 дни).',
            'display_order' => 2
        ]);
        \App\Models\Faq::create([
            'page_slug' => 'baptism',
            'question_bg' => 'Снимате ли в ресторанта?',
            'answer_bg' => 'Да, предлагаме разширен пакет, който включва и заснемане на тържеството в ресторанта (посрещане, разрязване на питата, торта и весели моменти с гостите).',
            'display_order' => 3
        ]);

        // Prom FAQs
        \App\Models\PromFaq::create([
