...
@section('content')
    <div class="contract-title">Договор за фото/видео заснемане на събитие</div>
    ...
    <div class="party-info">
        ...
        Лице за контакт: {!! pdfBlank($data['client1_name'] ?? '', 'blank-long') !!}<br>
    ...
    <table>
        ...
        <tr><th>Тип събитие</th><td>{!! pdfBlank($data['event_type_detail'] ?? '', 'blank-long') !!}</td></tr>
