...
| `app/Filament/Pages/GameStats.php` + `resources/views/filament/pages/game-stats.blade.php` | create | Страница „QR Игра – статистика“ в група „Маркетинг“ (header widgets + инструкция за валидация на код) |
...
Страницата (`resources/views/filament/pages/game-stats.blade.php`) съдържа и кратка инструкция „Как да валидираш код от Instagram DM“. Ресурсът със събитията е със label „QR Игра – събития“ (sort 2) в същата група.
